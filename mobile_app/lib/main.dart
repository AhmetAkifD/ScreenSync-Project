              ...
              showModalBottomSheet(
                ...
                builder: (context) => SettingsBottomSheet(
                  ...
                  onSettingsSaved: (command) {
                    // Komut geliyor: "SETTINGS|6|1080p"
                    final parts = command.split('|');
                    final int newBitrate = int.parse(parts[1]);
                    final String newResolution = parts[2];

                    // Arayüzdeki aktif değerleri güncelliyoruz ki panel hafızada kalsın
                    setState(() {
                      activeBitrate = newBitrate.toDouble();
                      activeResolution = newResolution;
                    });

                    // YENİ EKLENEN KISIM: MainPageTools içindeki metodumuzu çağırıyoruz!
                    // (Eğer senin sınıfının adı 'tools' değilse kendi değişken adını kullan)
